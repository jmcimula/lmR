#'Building a Model with Top Ten Feautures
#'
...
#'@return a vector of coefficients from the final model with top 10 features
...
#'final set of 10 predictors is taken  from 10 smallest p-values.
#'@seealso \code{lm}
#'@export
#'@importFrom stats lm
